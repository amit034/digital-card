 ...
 * All text, images, and contact information can be modified here.
 */
...
const cardData = {
  ...
  // ===== CONTACT DETAILS =====
  phone: '052-6407620',        // Mobile phone
  office: '03-6542333',        // Office phone
  email: 'batel@delta-ins.co.il',
  website: 'https://delta-ins.co.il',
  whatsapp: '9720526407620',   // WhatsApp number (with country code, no +)

...
const cards = [
  ...
  },
  {
    ...
    description: 'עו"ד אייל פלשן, חבר בלשכת עורכי הדין בישראל החל משנת 2003. בוגר תואר ראשון במשפטים בהצטיינות מאוניברסיטת תל אביב ותואר שני "מגיסטר במקרקעין" מהטכניון. בעל ניסיון של למעלה מ-20 שנה בתחום המקרקעין, ביטוח ונזיקין, ליטיגציה אזרחית ודיני עבודה.',
